...
### Bootstrapping Pset Utils (10 points)
...
| project_name | `Pset Utils` |
| repo_name | `2019sp-pset-utils-YOUR_GITHUB_ID` |
| package_name | (should default to `pset_utils`) |
| test_runner | `pytest` |
| travis | `yes` |
| codecov | `no` |
| requiresio | `no` |
...
Ensure the tests are included ***inside*** the pset_utils package, as we will
...
***All instructions below refer to the pset 1 repo, not pset_utils.***
